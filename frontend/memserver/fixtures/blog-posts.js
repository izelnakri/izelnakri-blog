export default [
  {
    ...
    markdown_content: "Few months ago I rewrote the search functionality for a web application using only Ecto & PostgreSQL. As it turns out postgres text search is very good.",
